class BaseRoute {
  ...
  static const String waterBill = "/water_bill_route";

  static const String cable = "/cable_route";

  static const String educationFee = "/education_fee_route";

  static const String virtualCard = "/virtual_card_route";

  static const String createNewCard = "/create_new_card_route";
