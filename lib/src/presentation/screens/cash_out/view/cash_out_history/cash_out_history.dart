...
import 'package:qunzo_user/src/presentation/screens/cash_out/view/cash_out_history/sub_sections/cash_out_transaction_filter_bottom_sheet.dart';
          ...
          children: [
            Column(
              children: [
                ...
                CommonAppBar(
                  title: localization.cashOutHistoryTitle,
                  rightSideWidget: GestureDetector(
                    onTap: () {
                      Get.bottomSheet(CashOutTransactionFilterBottomSheet());
                    },
                    child: Container(
