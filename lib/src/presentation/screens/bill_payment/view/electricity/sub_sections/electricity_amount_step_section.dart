...
class ElectricityAmountStepSection extends StatelessWidget {
  const ElectricityAmountStepSection({super.key});
            ...
            child: Column(
              children: [
                ...
                CommonRequiredLabelAndDynamicField(
                  labelText: localization!.electricityCountryLabel,
                      ...
                      onTap: () {
                        Get.bottomSheet(
                          CommonDropdownBottomSheet(
                            isShowTitle: true,
                            title: localization.electricityCountrySelectTitle,
                            ...
                            notFoundText:
                                localization.electricityCountryNotFound,
                          ),
                        );
                      },
                      hintText: localization.electricityCountryHint,
                ...
                CommonRequiredLabelAndDynamicField(
                  labelText: localization.electricityServiceLabel,
                  isLabelRequired: true,
                  dynamicField: Obx(
                    () => CommonTextInputField(
                      suffixIcon: Image.asset(PngAssets.arrowDownCommonIcon),
                      ...
                      onTap: () {
                        Get.bottomSheet(
                          CommonDropdownBottomSheetThree<PayBillServiceData>(
                            ...
                            bottomSheetHeight: 400.h,
                            isShowTitle: true,
                            title: localization.electricityServiceSelectTitle,
                            notFoundText:
                                localization.electricityServiceNotFound,
                      ...
                      hintText: localization.electricityServiceHint,
                ...
                Obx(() {
                  ...
                  return CommonRequiredLabelAndDynamicField(
                    labelText: localization.electricityAmountLabel,
                    isLabelRequired: true,
                ...
                CommonButton(
                  text: localization.electricityPayButton,
                  onPressed: () {
