...
class WaterBillAmountStepSection extends StatelessWidget {
  const WaterBillAmountStepSection({super.key});
            ...
            child: Column(
              children: [
                ...
                CommonRequiredLabelAndDynamicField(
                  labelText: localization!.waterBillCountryLabel,
                      ...
                      onTap: () {
                        Get.bottomSheet(
                          CommonDropdownBottomSheet(
                            isShowTitle: true,
                            title: localization.waterBillCountrySelectTitle,
                            ...
                            notFoundText: localization.waterBillCountryNotFound,
                          ),
                        );
                      },
                      hintText: localization.waterBillCountryHint,
                ...
                CommonRequiredLabelAndDynamicField(
                  labelText: localization.waterBillServiceLabel,
                  isLabelRequired: true,
                  dynamicField: Obx(
                    () => CommonTextInputField(
                      suffixIcon: Image.asset(PngAssets.arrowDownCommonIcon),
                      ...
                      onTap: () {
                        Get.bottomSheet(
                          CommonDropdownBottomSheetThree<PayBillServiceData>(
                            ...
                            bottomSheetHeight: 400.h,
                            isShowTitle: true,
                            title: localization.waterBillServiceSelectTitle,
                            notFoundText: localization.waterBillServiceNotFound,
                      ...
                      hintText: localization.waterBillServiceHint,
                ...
                Obx(() {
                  ...
                  return CommonRequiredLabelAndDynamicField(
                    labelText: localization.waterBillAmountLabel,
                    isLabelRequired: true,
                ...
                CommonButton(
                  text: localization.waterBillPayButton,
                  onPressed: () {
