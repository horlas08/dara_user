...
class WaterBillReviewStepSection extends StatelessWidget {
  const WaterBillReviewStepSection({super.key});
    ...
    return SingleChildScrollView(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(
              localization!.waterBillReviewTitle,
              style: TextStyle(
                letterSpacing: 0,
                ...
                children: [
                  Obx(
                    () => _buildReviewDynamicContent(
                      context,
                      title: localization.waterBillReviewAmountLabel,
                      content:
                  ...
                  Obx(
                    () => _buildReviewDynamicContent(
                      context,
                      title: localization.waterBillReviewChargeLabel,
                  ...
                  Obx(
                    () => _buildReviewDynamicContent(
                      context,
                      title: localization.waterBillReviewConversionRateLabel,
                  ...
                  Obx(() {
                    ...
                    return _buildReviewDynamicContent(
                      context,
                      title: localization.waterBillReviewPayableAmountLabel,
                      content: payableText,
                      contentColor: AppColors.lightTextPrimary,
                    );
                  }),
              ...
              children: [
                Expanded(
                  child: CommonIconButton(
                    ...
                    height: 52,
                    text: localization.waterBillReviewBackButton,
                ...
                Expanded(
                  child: CommonIconButton(
                    ...
                    width: double.infinity,
                    height: 52,
                    text: localization.waterBillReviewConfirmButton,
