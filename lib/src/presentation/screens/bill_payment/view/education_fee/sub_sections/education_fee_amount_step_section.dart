...
class EducationFeeAmountStepSection extends StatelessWidget {
  const EducationFeeAmountStepSection({super.key});
            ...
            child: Column(
              children: [
                ...
                CommonRequiredLabelAndDynamicField(
                  labelText: localization!.educationFeeCountryLabel,
                      ...
                      onTap: () {
                        Get.bottomSheet(
                          CommonDropdownBottomSheet(
                            isShowTitle: true,
                            title: localization.educationFeeCountrySelectTitle,
                            ...
                            notFoundText:
                                localization.educationFeeCountryNotFound,
                          ),
                        );
                      },
                      hintText: localization.educationFeeCountryHint,
                ...
                CommonRequiredLabelAndDynamicField(
                  labelText: localization.educationFeeServiceLabel,
                  isLabelRequired: true,
                  dynamicField: Obx(
                    () => CommonTextInputField(
                      suffixIcon: Image.asset(PngAssets.arrowDownCommonIcon),
                      ...
                      onTap: () {
                        Get.bottomSheet(
                          CommonDropdownBottomSheetThree<PayBillServiceData>(
                            ...
                            bottomSheetHeight: 400.h,
                            isShowTitle: true,
                            title: localization.educationFeeServiceSelectTitle,
                            notFoundText:
                                localization.educationFeeServiceNotFound,
                      ...
                      hintText: localization.educationFeeServiceHint,
                ...
                Obx(() {
                  ...
                  return CommonRequiredLabelAndDynamicField(
                    labelText: localization.educationFeeAmountLabel,
                    isLabelRequired: true,
                ...
                CommonButton(
                  text: localization.educationFeePayButton,
                  onPressed: () {
