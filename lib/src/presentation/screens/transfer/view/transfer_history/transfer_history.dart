...
import 'package:qunzo_user/src/presentation/screens/transfer/view/transfer_history/sub_sections/transfer_transaction_filter_bottom_sheet.dart';
          ...
          children: [
            Column(
              children: [
                ...
                CommonAppBar(
                  title: localization.transferHistoryScreenTitle,
                  rightSideWidget: GestureDetector(
                    onTap: () {
                      Get.bottomSheet(TransferTransactionFilterBottomSheet());
                    },
                    child: Container(
